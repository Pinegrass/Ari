...
# Requires: .env with SECRET_KEY, at least one AI provider key, and Supabase keys
...
### Repo Structure
- Frontend: `github.com/Pinegrass/Ari` (working branch **master**) at `D:\Codex\Workex\Ari`
...
| POST | /parse/expense | Multi-provider AI expense parsing (structured JSON, PII-scrubbed) |
...
DEEPSEEK_API_KEY=<deepseek-key>    # primary
GEMINI_API_KEY=<google-gemini-key> # fallback
AI_PROVIDER=deepseek               # or an explicit order: deepseek,gemini
CORS_ORIGIN=*
