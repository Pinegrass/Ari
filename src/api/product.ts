...
export interface PlanningResult {inputs:PlanningInputs|null;status:string;confirmedAt?:string;estimate:{remaining:string;obligations:string;days:number;perDay:string}|null}
